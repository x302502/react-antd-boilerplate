...
export const demoItems: DemoItem[] = [
  ...
  },
  {
    ...
    description: 'Leveraging the power of Ant Design to create beautiful and consistent user interfaces.',
    tag: 'Components',
    color: 'purple',
  },
  {
    key: 3,
    title: 'React Hooks',
    description: 'Using modern React patterns with hooks for state management and side effects.',
    tag: 'React',
    color: 'green',
  },
  {
