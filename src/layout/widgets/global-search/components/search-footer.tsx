		...
		<>
			...
			<div className="px-4 py-2 flex items-center justify-between text-xs">
				<div className="flex items-center">
					<span className="flex items-center justify-center p-1 h-5 rounded-md bg-[#F3F4F5] dark:bg-[#26313C]">
						<ArrowUpOutlined />
					</span>
					<span className="flex items-center justify-center p-1 h-5 rounded-md bg-[#F3F4F5] dark:bg-[#26313C] ml-2">
						<ArrowDownOutlined />
					</span>
